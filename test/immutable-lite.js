...
describe('Basic *In method tests', function () {
    ...
    it('should unshiftIn correctly', function () {
        immutable.unshiftIn([0], [], [1, 2, 3]).should.deep.equal([3, 2, 1, 0]);
    });
    ...
    it('should applyIn correctly', function () {
        immutable.applyIn({ name: 'Pet', age: 32 }, ['name'], function (v) { return v + 'e'; }).should.deep.equal({ name: 'Pete', age: 32 });
    });
});
